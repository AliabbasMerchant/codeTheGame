...
#     #     self.save_to_json()
#
#     # def __init__(self, team_bowl, team_bat, json):
#     #     self.team_bowl = team_bowl
#     #     self.team_bat = team_bat
#     #     self.json_file=self.team_bat+" vs "+self.team_bowl
#
...
#         print("read csv")
#
#     #     return self.csv  # the list from csvFile
#     #
#     # def create_player(name, team, position):
#     #     if ball[bowler]:
#     #         pass
#     #     else:
#     #         bowl1 = new Player(ball[bowler], team_bowl, "bowler")
#
#
#     def allot_data(self):
...
#             elif row_num == 1:  # check with Swapnil
#                 pass
#             else:
#                 # ball_no= ball[0]
...
#
#                 if fielder_name:
#                     name_team_role = player.resolve_name_team_role(fielder_name, self.team_bowl)
#                     try:
#                         if self.data[name_team_role[0]] :
#                             pass
#                         else:
...
#
#         # data = json.load(open(self.json_file+".json"))
#         # pprint(data)
#         # name_team_role = player.resolve_name_team_role(player_name)
#         # player = data[self.team_bat][name_team_role[0]]  #please check
#
#         for player in self.data:
#             if float(self.data[player]["runs"]) == 0 and self.data[player]["team"] != self.team_bowl :
...
#             # points += float(self.data[player]["catch"]) * catch_score
#             # points += float(self.data[player]["stump"]) * stump_score
#             # points += float(self.data[player]["run_out"]) * run_out_score
#             # points += float(self.data[player]["throws"]) * throw_score
    ...
    def calculate_scores(self):
        ...
        for player in self.data:
            ...
            if float(self.data[player]["runs"]) >= 100.0:
                ...
                self.data[player]["fifties"] = 1
            if self.data[player]["name"]=="HH PANDYA":
                pass # print(points)
